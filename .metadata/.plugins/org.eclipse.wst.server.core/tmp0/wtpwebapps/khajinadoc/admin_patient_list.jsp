...
<!DOCTYPE html>
<head>
<title>Visitors an Admin Panel Category Bootstrap Responsive
	Website Template | Responsive_table :: w3layouts</title>
			...
			<div id="sidebar" class="nav-collapse">
				...
				<div class="leftside-navigation">
					<ul class="sidebar-menu" id="nav-accordion">
						<li><a class="active" href="admin-home.jsp"> <i
								class="fa fa-dashboard"></i> <span>Dashboard</span>
						</a></li>

						<li class="sub-menu"><a href="admin-seller-list.jsp"> <i
								class="fa fa-book"></i> <span>Sellers</span>
						</a></li>
						<li><a href="admin-customer-list.jsp"> <i
								class="fa fa-bullhorn"></i> <span>Customers</span>
						</a></li>
						<li class="sub-menu"><a href="admin-product-list.jsp"> <i
								class="fa fa-th"></i> <span>Products</span>
						</a></li>
						<li class="sub-menu"><a href="all-payments.jsp"> <i
								class="fa fa-tasks"></i> <span>Payments</span>
						</a></li>
